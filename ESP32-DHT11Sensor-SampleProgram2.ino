...
// 温度 MQTT トピックス
#define MQTT_PUB_TEMP "temperature1"//esp32/dhtReadmqttdata/
#define MQTT_PUB_HUM  "humidity1"//esp32/dhtReadmqttdata/
#define MQTT_PUB_HIN "heatindex1"//esp32/dhtReadmqttdata/
#define MQTT_PUB_HINL "heatlevel1"//esp32/dhtReadmqttdata/
